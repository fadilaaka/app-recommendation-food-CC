...
def foods_recommendation():
    if request.method == 'POST':
        ...
        cursor.execute(
            f"SELECT f.id AS food_id, f.uuid AS food_uuid, f.name AS food_name, f.description AS food_description, f.image AS food_image, f.price AS food_price, f.status AS food_status, f.foodTagsId AS food_tags_id, fd.id AS food_detail_id, fd.uuid AS food_detail_uuid, fd.fat AS food_detail_fat, fd.protein AS food_detail_protein, fd.carbohidrat AS food_detail_carbohidrat, fd.calories AS food_detail_calories, fr.id AS food_recipe_id, fr.uuid AS food_recipe_uuid, fr.name AS food_recipe_name, fr.description AS food_recipe_description, fr.image AS food_recipe_image, ft.id AS food_tags_id, ft.uuid AS food_tags_uuid, ft.name AS food_tags_name, ft.description AS food_tags_description, ft.image AS food_tags_image FROM Food AS f LEFT JOIN FoodDetail AS fd ON f.id = fd.foodId LEFT JOIN FoodRecipe AS fr ON f.id = fr.id LEFT JOIN FoodTags AS ft ON f.foodTagsId = ft.id WHERE f.name = '{RecommendedLunch[0]}'")
        lunch = cursor.fetchone()

        cursor.execute(
            f"SELECT f.id AS food_id, f.uuid AS food_uuid, f.name AS food_name, f.description AS food_description, f.image AS food_image, f.price AS food_price, f.status AS food_status, f.foodTagsId AS food_tags_id, fd.id AS food_detail_id, fd.uuid AS food_detail_uuid, fd.fat AS food_detail_fat, fd.protein AS food_detail_protein, fd.carbohidrat AS food_detail_carbohidrat, fd.calories AS food_detail_calories, fr.id AS food_recipe_id, fr.uuid AS food_recipe_uuid, fr.name AS food_recipe_name, fr.description AS food_recipe_description, fr.image AS food_recipe_image, ft.id AS food_tags_id, ft.uuid AS food_tags_uuid, ft.name AS food_tags_name, ft.description AS food_tags_description, ft.image AS food_tags_image FROM Food AS f LEFT JOIN FoodDetail AS fd ON f.id = fd.foodId LEFT JOIN FoodRecipe AS fr ON f.id = fr.id LEFT JOIN FoodTags AS ft ON f.foodTagsId = ft.id WHERE f.name = '{RecommendedDinner[0]}'")
        dinner = cursor.fetchone()

        cursor.execute(
            f"SELECT f.id AS food_id, f.uuid AS food_uuid, f.name AS food_name, f.description AS food_description, f.image AS food_image, f.price AS food_price, f.status AS food_status, f.foodTagsId AS food_tags_id, fd.id AS food_detail_id, fd.uuid AS food_detail_uuid, fd.fat AS food_detail_fat, fd.protein AS food_detail_protein, fd.carbohidrat AS food_detail_carbohidrat, fd.calories AS food_detail_calories, fr.id AS food_recipe_id, fr.uuid AS food_recipe_uuid, fr.name AS food_recipe_name, fr.description AS food_recipe_description, fr.image AS food_recipe_image, ft.id AS food_tags_id, ft.uuid AS food_tags_uuid, ft.name AS food_tags_name, ft.description AS food_tags_description, ft.image AS food_tags_image FROM Food AS f LEFT JOIN FoodDetail AS fd ON f.id = fd.foodId LEFT JOIN FoodRecipe AS fr ON f.id = fr.id LEFT JOIN FoodTags AS ft ON f.foodTagsId = ft.id WHERE f.name = '{RecommendedSnackPagi[0]}'")
        snackpagi = cursor.fetchone()

        cursor.execute(
            f"SELECT f.id AS food_id, f.uuid AS food_uuid, f.name AS food_name, f.description AS food_description, f.image AS food_image, f.price AS food_price, f.status AS food_status, f.foodTagsId AS food_tags_id, fd.id AS food_detail_id, fd.uuid AS food_detail_uuid, fd.fat AS food_detail_fat, fd.protein AS food_detail_protein, fd.carbohidrat AS food_detail_carbohidrat, fd.calories AS food_detail_calories, fr.id AS food_recipe_id, fr.uuid AS food_recipe_uuid, fr.name AS food_recipe_name, fr.description AS food_recipe_description, fr.image AS food_recipe_image, ft.id AS food_tags_id, ft.uuid AS food_tags_uuid, ft.name AS food_tags_name, ft.description AS food_tags_description, ft.image AS food_tags_image FROM Food AS f LEFT JOIN FoodDetail AS fd ON f.id = fd.foodId LEFT JOIN FoodRecipe AS fr ON f.id = fr.id LEFT JOIN FoodTags AS ft ON f.foodTagsId = ft.id WHERE f.name = '{RecommendedSnackSiang[0]}'")
